...
public interface CommonValidator {
    ...
    default void setMessageAttribute(List<String> messages, HttpServletRequest request, String messageType) {
    ...
    default void checkOnValueAndLength(Integer checkedParameter, List<String> messages, String parameterName) {
    ...
    default void checkOnRegExp(String checkedParameter, List<String> messages, String parameterName) {
        if (checkedParameter != null) {
